...
var DEBUG, GAME_HEIGHT, GRAVITY, GROUND_HEIGHT, GROUND_Y, HARD, HEIGHT, SPAWN_RATE, SPEED, WIDTH, avoidText, bestScore, bestText, bg, birdsTimer, blood, bloods, board, dieRate, fallSnd, flapSnd, floor, gameOver, gameOverText, gameStart, gameStartText, ground, hurtSnd, instText, main, resetText, score, scoreSnd, scoreText, swooshSnd, tube;
...
main = function() {
  ...
  createBirds = function() {
    var bird, i, race, raceName, superRate, _i, _ref;
    dieRate = score / HARD;
    superRate = 0.01;
    birdys.forEachAlive(function(bird) {
